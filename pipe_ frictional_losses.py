...
def main():
    ...
    user_input = input('Press 1 for Pressure Drop Calc\nPress 2 for Flowrate Calc\nPress 3 for Diameter Calc \n')
    
    if user_input == '1':
        Calc_Frictional_Losses()
    elif user_input == '2':
        Flowrate_Calc()
    else:
        Diameter_Calc()
...
def Calc_Frictional_Losses():
    ...
    Reynolds_Number(V,Fluid_Viscoisty,Fluid_Density,Pipe_Inner_Diamter,Pipe_Roughness,Pipe_Length)
